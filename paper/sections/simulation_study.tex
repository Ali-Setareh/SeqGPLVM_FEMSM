...
effect of treatments received in the last three time points, the sum of observed covariates at the final time point, 
...
the governing equations for the DGP. Here, $\operatorname{expit}(x) = \frac{1}{1 + e^{-x}}$ and 
...
Our target estimands are $\tau_F$ and  and the cumulative effect of the last three treatments:
