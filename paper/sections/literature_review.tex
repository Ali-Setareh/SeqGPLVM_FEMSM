...
of the causal diagram. A causal diagram $\mathcal{G}$ consist of 
a set of nodes $\mathbf{V}$ and a set of directed edges $\mathbf{E}$. 
...
, i.e. the presence or absence of treatment-confounder feedback or presence 
of unobserved confounders. This dimension 
is more about how the study is designed and the data is collected. The second dimension is about the causal target of interest. This dimension is more 
about the research question \cite{lundbergWhatYourEstimand2021}. One of the most common causal estimands in longitudinal data is the 
