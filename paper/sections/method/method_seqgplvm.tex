...
implicitly assume a assumption that we call here \emph{No single-time-point confounding} assumption. This  
...
\begin{assumpSG}
    ...
    (i) $A_t \not\!\perp\!\!\!\perp Y(\bar a_T)\mid \bar A_{t-1},\bar X_t$ for some $\bar a_T$ (i.e., $U_t$ 
    confounds the effect of $A_t$ on the outcome),
    and (ii) $U_t \perp\!\!\!\perp \bar A_{-t}\mid \bar A_{t-1},\bar X_t$ (i.e., $U_t$ 
