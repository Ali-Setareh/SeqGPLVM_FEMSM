...
$\mathbb{E}[Y_i(\bar{a})]$ in terms of observed data. Based on our identification 
strategy, we need to model different stuff. For instance in the case of identification of 
$\mathbb{E}[Y_i(\bar{a})]$ using IPTW, we must model the propensity scores. Modeling assumptions 
are concenred with the necessary assumption about this part of the procedure. At the end, 
we may need to estimate different parts of the procedure using different methods/estimators, 
and each method may require its own set of assumptions. 
...
In this section, we outline the common identification and modeling assumptions 
behind both FE--MSM and SeqGPLVM approaches. Both methods described in this section 
